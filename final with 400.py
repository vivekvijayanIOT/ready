...
def searching(x,y,r,times):
	...
	if(N26.check!=1):
		...
		if(z < (N26.radius+r)):
			w=("\t\tNode26 Found at [xpos:%s][ypos:%s]  \n\t\tNode26 -> Charge:%d"%(N26.xpos,N26.ypos,N26.charge))
			mfile.write("\n\n"+w)
			print(w)
			N26.check=1
			visited+=1
	...
	if(N28.check!=1):
		...
		if(z < (N28.radius+r)):
			w=("\t\tNode28 Found at [xpos:%s][ypos:%s]  \n\t\tNode28 -> Charge:%d"%(N28.xpos,N28.ypos,N28.charge))
			mfile.write("\n\n"+w)
			print(w)
			N28.check=1
			visited+=1
	...
	if(N29.check!=1):
		...
		if(z < (N29.radius+r)):
			w=("\t\tNode29 Found at [xpos:%s][ypos:%s]  \n\t\tNode29 -> Charge:%d"%(N29.xpos,N29.ypos,N29.charge))
			mfile.write("\n\n"+w)
			print(w)
			N29.check=1
			visited+=1
	...
	if(N30.check!=1):
		...
		if(z < (N30.radius+r)):
			w=("\t\tNode30 Found at [xpos:%s][ypos:%s]  \n\t\tNode30 -> Charge:%d"%(N30.xpos,N30.ypos,N30.charge))
			mfile.write("\n\n"+w)
			print(w)
			N30.check=1
			visited+=1
	...
	if(N31.check!=1):
		...
		if(z < (N31.radius+r)):
			w=("\t\tNode31 Found at [xpos:%s][ypos:%s]  \n\t\tNode31 -> Charge:%d"%(N31.xpos,N31.ypos,N31.charge))
			mfile.write("\n\n"+w)
			print(w)
			N31.check=1
			visited+=1
	...
	if(N32.check!=1):
		...
		if(z < (N32.radius+r)):
			w=("\t\tNode32 Found at [xpos:%s][ypos:%s]  \n\t\tNode32 -> Charge:%d"%(N32.xpos,N32.ypos,N32.charge))
			mfile.write("\n\n"+w)
			print(w)
			N32.check=1
			visited+=1
	...
	if(N34.check!=1):
		...
		if(z < (N34.radius+r)):
			w=("\t\tNode34 Found at [xpos:%s][ypos:%s]  \n\t\tNode34 -> Charge:%d"%(N34.xpos,N34.ypos,N34.charge))
			mfile.write("\n\n"+w)
			print(w)
			N34.check=1
			visited+=1
	...
	if(N35.check!=1):
		...
		if(z < (N35.radius+r)):
			w=("\t\tNode35 Found at [xpos:%s][ypos:%s]  \n\t\tNode35 -> Charge:%d"%(N35.xpos,N35.ypos,N35.charge))
			mfile.write("\n\n"+w)
			print(w)
			N35.check=1
			visited+=1
	...
	if(N36.check!=1):
		...
		if(z < (N36.radius+r)):
			w=("\t\tNode36 Found at [xpos:%s][ypos:%s]  \n\t\tNode36 -> Charge:%d"%(N36.xpos,N36.ypos,N36.charge))
			mfile.write("\n\n"+w)
			print(w)
			N36.check=1
			visited+=1
	...
	if(N37.check!=1):
		...
		if(z < (N37.radius+r)):
			w=("\t\tNode37 Found at [xpos:%s][ypos:%s]  \n\t\tNode37 -> Charge:%d"%(N37.xpos,N37.ypos,N37.charge))
			mfile.write("\n\n"+w)
			print(w)
			N37.check=1
			visited+=1
	...
	if(N38.check!=1):
		...
		if(z < (N38.radius+r)):
			w=("\t\tNode38 Found at [xpos:%s][ypos:%s]  \n\t\tNode38 -> Charge:%d"%(N38.xpos,N38.ypos,N38.charge))
			mfile.write("\n\n"+w)
			print(w)
			N38.check=1
			visited+=1
	...
	if(N39.check!=1):
		...
		if(z < (N39.radius+r)):
			w=("\t\tNode39 Found at [xpos:%s][ypos:%s]  \n\t\tNode39 -> Charge:%d"%(N39.xpos,N39.ypos,N39.charge))
			mfile.write("\n\n"+w)
			print(w)
			N39.check=1
			visited+=1
	...
	if(N40.check!=1):
		...
		if(z < (N40.radius+r)):
			w=("\t\tNode40 Found at [xpos:%s][ypos:%s]  \n\t\tNode40 -> Charge:%d"%(N40.xpos,N40.ypos,N40.charge))
			mfile.write("\n\n"+w)
			print(w)
			N40.check=1
			visited+=1
